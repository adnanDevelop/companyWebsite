  ...
  return (
    <>
      <div className=" w-full bg-blue padding-inline ">
        <div className="footer_section  pt-[60px]   pb-[20px] flex items-center gap-3 xl:gap-6  flex-wrap">
          {/* FOOTER DETAIL AND LINKS SECTION */}
          <div className="flex justify-between xl:gap-[60px] gap-[40px] sm:flex-nowrap  flex-wrap ">
            {/*LINK SECTION */}
            ...
            {/* DETAIL SECTION */}
            <div className="footer-detail_section">
